...
class AdminInvigilatorDetailsUpdate extends StatefulWidget {
  ...
  String event_id;
  SaveUser _user;
  AdminInvigilatorDetailsUpdate(
      this._user, this._postgresKonnection, this.guest_id, this.event_id);
...
class _AdminInvigilatorDetailsUpdateState
    extends State<AdminInvigilatorDetailsUpdate> {
